...
fun bindWinner(imageView: ImageView, isWinner: Boolean) {
...
@BindingAdapter("requiredRightAnswersPercent")
fun bindRequiredRightAnswersPercent(textView: TextView, percentage: Int) {
    textView.text = String.format(
...
fun bindProgressColor(progressBar: ProgressBar, enoughCount: Boolean) {
    val color = getColorByState(progressBar.context, enoughCount)
    progressBar.progressTintList = ColorStateList.valueOf(color)
}

@BindingAdapter("requiredAnswersProgress")
fun bindRequiredAnswersProgress(textView: TextView, enoughCount: Boolean) {
